      ...
      {projects.map((project, index) => {
        ...
        return (
          ...
          >
            ...
            <Link href={`/work/${slug}`} className="relative block h-full flex flex-col">
              ...
              <div className="mt-6 flex flex-col flex-1 px-1">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs font-medium text-white/50 mb-3">
                  ...
                  {project.year && project.role && <span className="w-1 h-1 rounded-full bg-white/20" />}
                  {project.role && <span className="uppercase tracking-wider">{project.role}</span>}
                </div>
