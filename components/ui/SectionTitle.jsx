  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4 w-full">
      <div className="relative flex flex-col items-center justify-center w-full max-w-5xl mx-auto overflow-hidden py-4">
        ...
        <span className="text-[12vw] sm:text-[10vw] md:text-[8rem] lg:text-[9rem] leading-none font-extrabold bg-linear-to-b from-white/10 to-transparent bg-clip-text text-transparent select-none tracking-tighter whitespace-nowrap text-center z-0 pointer-events-none">
          {title.toUpperCase()}
        </span>
      ...
      <div className="flex items-center gap-4 my-6 z-10">
        <div className="h-px w-12 sm:w-16 bg-linear-to-r from-transparent to-[#ea580c]/40" />
        <div className="h-1.5 w-1.5 rounded-full bg-[#ea580c] shadow-[0_0_8px_rgba(234,88,12,0.6)]" />
        <div className="h-px w-12 sm:w-16 bg-linear-to-l from-transparent to-[#ea580c]/40" />
      </div>
