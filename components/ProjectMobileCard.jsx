...
export default function ProjectMobileCard({ project }) {
  ...
  return (
    ...
    >
      {/* Project Image Area */}
      <motion.div
        className="relative w-full h-56 sm:h-72 overflow-hidden border-b border-white/5 bg-black/50"
        variants={item}
      >
        {/* Subtle Orange Glow behind image */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(234,88,12,0.08),transparent_70%)] pointer-events-none z-0" />
      ...
      <div className="flex flex-col p-6 sm:p-8">
        ...
        <motion.div className="flex flex-col mb-4" variants={item}>
          <p className="text-[#ea580c] mb-2 text-xs sm:text-sm font-bold tracking-widest uppercase">
            {project.type}
          </p>
        ...
        {/* Action Buttons */}
        <motion.div
          className="flex w-full gap-3 sm:gap-4 mt-auto"
          variants={item}
        >
          {project.github && (
            <a
              ...
              className="flex h-12 w-1/2 items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 text-white/80 transition-all duration-300 hover:bg-white/10 hover:text-white active:scale-[0.98]"
            >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex h-12 flex-1 items-center justify-center gap-2 rounded-xl bg-[#ea580c]/10 border border-[#ea580c]/30 text-[#ea580c] transition-all duration-300 hover:bg-[#ea580c] hover:text-white hover:border-[#ea580c] active:scale-[0.98]"
          >
